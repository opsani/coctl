...
def get(ctx,file):
    ...
    url=f"https://api.opsani.com/accounts/{ctx.obj['account']}/applications/{ctx.obj['app']}/config/"
...
def stop(ctx):
    ...
    url=f"https://api.opsani.com/accounts/{ctx.obj['account']}/applications/{ctx.obj['app']}/state"
